...
public sealed class Dlss5UpstreamRefreshTests
{
    ...
    {
        Assert.Equal("1.16.0-beta.1", Dlss5ComponentService.BundledFeederBetaVersion);
        Assert.Equal("1.0.5", Dlss5ComponentService.OpenGlBridgeVersion);
        Assert.Equal("0.13.14", Dlss5ComponentService.OneClickVersion);
    ...
    [Fact]
    public void BundledFeederBetaPayloadIsTheMatched1160Beta1Set()
    {
        var assetRoot = Path.Combine(AppContext.BaseDirectory, "Assets", "DLSS5");
        var expected = new[]
        {
            "dlss5-feed-1.16.0-beta.1.addon64",
            "dlss5-feed-1.16.0-beta.1.addon32",
            "dlss5-feed-host64-1.16.0-beta.1.exe",
            "DLSS5_Feed-1.16.0-beta.1.fx",
            "feed-vk-layer-1.16.0-beta.1-x64.zip",
            "feed-vk-layer-1.16.0-beta.1-x86.zip",
        };
    ...
    [InlineData(Dlss5InstallProfile.LatestFeederBeta, Dlss5DeploymentMode.Dx11Feeder, "Feeder 1.16.0-beta.1", false)]
