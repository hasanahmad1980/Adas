...
$requiredDlss5Payload = @(
    ...
    'DLSS5_Feed.fx',
    'feed-vk-layer.zip',
    'dlss5-feed-0.14.0-beta.2.addon64',
    'dlss5-feed-0.14.0-beta.2.addon32',
    'dlss5-feed-host64-0.14.0-beta.2.exe',
    'DLSS5_Feed-0.14.0-beta.2.fx',
    'feed-vk-layer-0.14.0-beta.2-x64.zip',
    'feed-vk-layer-0.14.0-beta.2-x86.zip',
...
$expectedDlss5Hashes = @{
    ...
    'dlss5-feed-0.14.0-beta.2.addon64'     = 'DF8A56807CD5D5B769E45499C649492EF15EF3971F4B6E8034B615521F1E4C4B'
    'dlss5-feed-0.14.0-beta.2.addon32'     = '452F587DDA8E5BD508637E5B55BB5388F699AB9ED830DEB053072096CEB812D7'
    'dlss5-feed-host64-0.14.0-beta.2.exe'  = 'A088163B2CC19543D83D6F876D9E32D0D52E4A463E7CADCEA20F688B0EA566E3'
    'DLSS5_Feed-0.14.0-beta.2.fx'          = '491815122018D17D460F02ADC0E5F03ABB6E7489E3B8136BA003927EE06858E9'
    'feed-vk-layer-0.14.0-beta.2-x64.zip'  = '609A0ADC0099FBEE1B2B1559B55C655DB93D251FD18803C68EDEDCA9DFF723A7'
    'feed-vk-layer-0.14.0-beta.2-x86.zip'  = '9BD3FF6BB18CFDB950836023889806459DDE1EC9844970AE565D1C19DC49B46D'
