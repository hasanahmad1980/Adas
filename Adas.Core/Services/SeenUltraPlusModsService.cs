// SeenUltraPlusModsService.cs — Tracks which Ultra+ mods the user has "seen" so we can highlight new ones.
...
/// <summary>
/// Persists the set of Ultra+ mod names the user has acknowledged ("seen").
/// On refresh, any mods not in this set are considered "new" and can be highlighted in the UI.
/// </summary>
public class SeenUltraPlusModsService
{
    private static readonly string FilePath = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),
        "RHI", "seen_ultraplus_mods.json");
    ...
    /// <summary>
    /// Given the current Ultra+ mod list, returns the names of mods not yet seen.
